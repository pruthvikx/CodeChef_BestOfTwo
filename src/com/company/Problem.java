...
In the first attempt, he scored XX marks while
in the second attempt he scored YY marks.
...
TT — the number of test cases. Then the test cases follow.
The first line of each test case contains two
integers XX and YY — the marks scored by Chef in
the first attempt and second attempt respectively.
